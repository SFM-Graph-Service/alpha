...
class MonitoringMiddleware(BaseHTTPMiddleware):
    ...
    def __init__(self, app: ASGIApp, config: Dict[str, Any] = None):
        ...
        self.excluded_paths = set(self.config.get('excluded_paths', ['/health', '/metrics']))
    ...
    async def _log_response(self, request: Request, response: Response, duration: float, logger):
        """Log response details."""
...
def create_monitoring_middleware(app: ASGIApp, config: Dict[str, Any] = None) -> ASGIApp:
    """
