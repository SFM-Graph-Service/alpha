...
class PerformanceMetrics:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            self.operation_count if self.operation_count > 0 else 0.0,
...
class MetricsCollector:
    ...
    def __init__(self, max_history_size: int = 1000):
        self._metrics: Dict[str, PerformanceMetrics] = defaultdict(
            PerformanceMetrics)
        self._custom_metrics: Dict[str, Deque[MetricValue]] = defaultdict(
            lambda: deque(maxlen=max_history_size))
        self._system_metrics: Deque[SystemResourceMetrics] = deque(
    ...
    def get_custom_metric(self, metric_name: str,
        ...
        with self._lock:
            ...
            return [{"value": v.value, "timestamp": v.timestamp,
                     "metadata": v.metadata} for v in values]
    ...
    def get_summary_stats(self) -> Dict[str, Any]:
        ...
        with self._lock:
            ...
            total_operations = sum(
                m.operation_count for m in self._metrics.values())
...
def record_operation_time(operation_name: str,
                          duration: float,
                          success: bool = True,
                          metadata: Optional[Dict[str,
                                                  Any]] = None):
